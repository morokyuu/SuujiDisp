...
class Tile:
    ...
    def rot(self,angle,x,y):
        xd = math.cos(angle)*x + math.sin(angle)*y
        yd = -math.sin(angle)*x  + math.cos(angle)*y
        return xd,yd
...
#        dy = math.sin(self.angle) * self.speed * dt
        ...
        dir_to_center_x += dir_to_center_y
        dir_to_center_y += -dir_to_center_x

        factor = self.speed * dt / dist
        self.x += dir_to_center_x * factor
        self.y += dir_to_center_y * factor
#        rx,ry = self.rot(self.angle, dir_to_center_x * factor, dir_to_center_y * factor)
#        self.x += 
#        self.y += 
